...
import Footer from "../Footer/Footer"; // Import for the Footer component
import Navigation from "../Navigation/Navigation"; // Import for the Navigation component
import "./Gallery.css"; // Import CSS for gallery styles
