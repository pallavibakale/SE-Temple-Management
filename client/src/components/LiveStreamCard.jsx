    ...
    <div className="container">
      ...
      /> */}
          ...
          <div className="live-stream-card" style={{backgroundColor:'#FFF7F0',padding: '60px'}}>
            ...
            <p>
              Celebrate, honor, and learn about Hinduism as we open our doors
              and invite the world to join us for prayers, ceremonies, and
              events from wherever one may be. Live streaming important
              religious and cultural events will allow devotees, students, and
              other interested persons from all over the world to watch, learn,
              and even participate from anywhere with an internet connection. It
              allows those who are unable to travel to the Temple a way to still
              take part in these important and sacred events.
            </p>
            <p>
